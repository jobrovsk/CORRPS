...
{a1,a2}=ExtendedEuclidean[t1,t2,a,y];
V = ParFracDecompAlt[a1,T[[;;Floor[n/2]]],y];
W = ParFracDecompAlt[a2,T[[Floor[n/2]+1;;]],y];
Return[Join[V,W]];
];


ParFracDecompAlt[(x^4-x^3-x^2+x-5),{(x-4),x+5,x+1,x^2+1},x]
ParFracDecomp[(x^4-x^3-x^2+x-5),{(x-4),x+5,x+1,x^2+1},x]
